          ...
          <motion.div key={item.key} variants={cardVariants}>
            <Card className="p-6 bg-white/70 backdrop-blur-md shadow-xl rounded-3xl border-0 dark:bg-gray-800/70 dark:text-gray-100 dark:shadow-gray-900/50">
              ...
              <div className="space-y-1">
                <p className="text-2xl font-bold tracking-tight text-foreground dark:text-gray-100">
                  {item.value}
                </p>
              ...
              <p className="text-xs text-muted-foreground mt-2 font-medium dark:text-gray-400">
                {item.sub}
              </p>
            </Card>
          </motion.div>
